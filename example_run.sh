...
--batch_size 200 --warm_epoch 50 --num_epochs 120 \
...
--remark coco_resnet_best \
--workers 4 --grad_clip 1 --dropout 0.1

#  example train script for COCO (Faster-RCNN)
python3 train.py \
--data_name coco_butd --cnn_type resnet152 --wemb_type glove \
--margin 0.1 --max_violation --img_num_embeds 2 --txt_num_embeds 2 \
--img_attention --txt_attention --img_finetune --txt_finetune \
--mmd_weight 0.01 --div_weight 0.0 --unif_weight 0.1 \
--batch_size 200 --warm_epoch 1 --num_epochs 50 \
...
--perceiver_input_dim 1024 --perceiver_query_dim 1024 \
--remark coco_butd_fast_best --img_1x1_dropout 0.1 --perceiver_pre_norm \
